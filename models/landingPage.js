...
//    content.links.push({ href: `${serviceUrl}/conformance`,        rel: `conformance`,  type: `application/json`,                             title: `OGC API conformance classes implemented by this server` } )
    content.links.push({ href: `${serviceUrl}/collections?f=json`, rel: `data`,         type: `application/json`,                             title: `Information about the file collections` } )
    content.links.push({ href: `${serviceUrl}/collections?f=html`, rel: `data`,         type: `text/html`,                                    title: `Information about the file collections` } )
